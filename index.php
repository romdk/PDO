...
<body>
    ...
    foreach ($products as $product) {
        $id = $product['ID'];
    ?>
        <p class="card" style="width: 20rem; margin-left:10px; padding:10px;">
            <a href=product.php?id=<?php echo $id ?>><?php echo $product['name']?></a><br>
            <?php echo mb_strimwidth($product['description'], 0, 50, "...")?><br>
            <?php echo $product['price']?>&euro;<br>
            <a href='traitement.php?action=ajouterPanier&id=<?php echo $id?>'>Ajouter au panier</a><br>
        </p><?php
        }
            ?>
